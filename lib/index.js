 ...
 *
 * The default implementation uses the pure JavaScript `lru-cache` as a cache,
 * with any options passed through in through the original `Config` constructor.
 *

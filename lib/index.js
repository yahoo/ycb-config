...
Config.prototype.addBundle = function(bundle) {
    ...
    if (!this._dimensionsPath) {
        if (bundle.resources &&
                ...
                bundle.resources[FALLBACK_SELECTOR].configs.dimensions) {
            this._dimensionsPath = libpath.resolve(bundle.baseDirectory, bundle.resources[FALLBACK_SELECTOR].configs.dimensions);
        }
    }
 ...
 * @return {Promise/A+} A promise that will be fulfilled once this object is optimized.
 */

    ...
    return new libpromise.Promise(function (fulfill, reject) {
        ...
        return self._readConfigContents(path).then(function (c) {
            ...
            ycb = {
                ...
                walkSettings: function walkSettings(callback) {
                    callback({}, contents);
                },
                read: function read(context, options) {
                    return contents;
                },
                readNoMerge: function readNoMerge(context, options) {
                    return [contents];
                }
            };
            self._configYCBs[path] = ycb;
